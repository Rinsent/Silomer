...
void hit() {
  ...
  if (analogRead (piez_pin)  > stray + (stray * interferenceFilter / 100)) {
    ...
    //Кусок отладки (удалить)
    Serial.print("exp_piez_max = "); Serial.print(exp_piez_max); Serial.print("   dif = "); Serial.print(dif); Serial.print("   piez_max = "); Serial.print (piez_max); Serial.print("   result_tm = "); Serial.print(result_tm); Serial.print("   step_tm = "); Serial.println(step_tm);
    Serial.print("unsigned long hit_max = exp_piez_max/9*dif = "); Serial.println(hit_max); Serial.print("unsigned long disp_max = piez_max*10000/hit_max= "); Serial.println(disp_max); Serial.print("disp_step = disp_max/(result_tm*1000/step_tm);= "); Serial.println(disp_step); Serial.print("unsigned long light_max = piez_max/(hit_max/11)= "); Serial.println(light_max);
    Serial.print("light_max = "); Serial.print(light_max); Serial.print("   lightTm = "); Serial.println(lightTm);
    ...
    while (true) {
      ...
      if (flagEf) {
        do {
          ...
          //Кусок отладки
          Serial.print (counterEf); Serial.print ("<="); Serial.println (counterEfMax);
